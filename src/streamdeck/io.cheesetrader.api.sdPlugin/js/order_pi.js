...
if ($SD) {
    $SD.on("connected", function (jsonObj) {
        ...
        if (jsonObj.hasOwnProperty('actionInfo')) {
            ...
            document.getElementById("order_type").value = settings.order_type || "";
            document.getElementById("symbol").value = settings.symbol || "";
            document.getElementById("lot_size").value = settings.lot_size || "";
        }
    });
};
const save = function () {
